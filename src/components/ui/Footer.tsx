...
export default function Footer() {
    ...
    return (
        <footer className={"w-full h-max pt-10 grid gap-5 text-white bg-primary-800"}>
            ...
            <div className={"w-full h-max flex gap-2 p-2.5 text-left pl-[2.5%] bg-primary-700"}>
                <Text className={"mt-auto mb-auto"}>{new Date().getFullYear()} &copy;Zamar Solution</Text>
